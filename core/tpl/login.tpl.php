...
<?php
if ($disablenofollow) echo '<a class="login_table_title" href="http://www.atconline.biz" target="_blank">';
echo 'ATC Online';
...
<!-- Button Connection -->
<br><input type="submit" class="button" value="&nbsp; <?php echo $langs->trans('Login'); ?> &nbsp;" tabindex="5" />
