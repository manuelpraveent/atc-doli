...
/**
 * \file    test/functional/invoiceFunctionalTest.php
 * \ingroup invoice
 ...
 * @package Testinvoice
 */
class invoiceFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/invoice/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('invoice/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/invoice/admin/about.php');
		$this->authenticate();
		return $this->assertContains('invoice/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('invoicewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modinvoice_invoiceTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modinvoice_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
