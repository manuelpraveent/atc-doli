...
dol_include_once("/invoice/class/myobject.class.php");


/**
 * mailing_mailinglist_invoice
 */
class mailing_mailinglist_invoice_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_invoice_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('invoice',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/invoice/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_invoice_myobject.modules.php: mailing ".$num." targets found");
