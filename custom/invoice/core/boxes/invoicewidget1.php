...
/**
 * \file    modulebuilder/template/core/boxes/invoicewidget1.php
 * \ingroup invoice
 * \brief   Widget provided by invoice
 *
 ...
 */
class invoicewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "invoicebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "invoice@invoice";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->invoice->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/invoice/class/invoice.class.php";

		// Populate the head at runtime
		$text = $langs->trans("invoiceBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_invoice@invoice',
