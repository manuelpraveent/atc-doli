...
/**
 *	\file       htdocs/invoice/template/invoiceindex.php
 *	\ingroup    invoice
 *	\brief      Home page of invoice top menu
 */
...
$langs->loadLangs(array("invoice@invoice"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->invoice->read) accessforbidden();
...
llxHeader("",$langs->trans("invoiceArea"));

print load_fiche_titre($langs->trans("invoiceArea"),'','invoice.png@invoice');
...
// Draft MyObject
if (! empty($conf->invoice->enabled) && $user->rights->invoice->read)
{
	$langs->load("orders");
